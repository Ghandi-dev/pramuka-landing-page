...
<template>
    <div class="relative border border-border rounded-lg overflow-hidden bg-muted/30 select-none">
        ...
        <Button
            ...
            class="absolute top-3 right-3 z-20 gap-1.5 shadow-lg"
        ...
        <div ref="pinboardWrapper" class="w-full h-[600px] overflow-hidden relative cursor-grab active:cursor-grabbing will-change-transform"
            ...
            <div ref="pinboardCanvas" class="w-[8000px] h-[4500px] relative will-change-transform preserve-3d">
                <div v-for="item in data" :key="item.id"
                    class="absolute w-40 select-none touch-none group"
        ...
        <div
            ...
            {{ editMode ? 'Seret gambar untuk mengubah posisi • Scroll untuk zoom' : 'Klik tombol "Mode Edit" untuk mengubah posisi gambar' }}
        </div>
    </div>
</template>
