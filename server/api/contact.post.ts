...
export default defineEventHandler(async (event) => {
    ...
    const { data: insertedData, status, error } = await supabase.from('contact_messages').insert({
    ...
    console.log('[contact.post] Supabase response:', { status, error, insertedData })
    console.log('[contact.post] Using key type:', config.public.supabasePublishableKey as string)
